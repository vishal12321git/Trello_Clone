  ...
  return (
    <div className=' w-66 ml-5 mt-1 border-1 rounded'>
      <div className='flex p-2 items-center'>
        ...
        <RxCross2 className='text-xl border-1 h-9 w-9 px-1 rounded hover:bg-gray-200' onClick={()=>setIsCheckListDialogOpen(false)}/>
      </div>
      <form
        ...
        ref={dialogRef}>
        <label>Title</label>
        <input type='text' className='border-1 h-10 w-full rounded' onChange={(e) => setTitle(e.target.value)} ref={inputRef}/>
        <button className='border-1 w-15 rounded px-1 h-10 my-2 hover:bg-gray-200' type='submit'>Add</button>
      </form>
    </div>
