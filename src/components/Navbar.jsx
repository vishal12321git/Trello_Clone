...
const Navbar = () => {
  ...
  return (
    <div className='shadow'>
      <div
        className='h-20 flex justify-between items-center gap-4 w-11/12 m-auto'>
        ...
        <div className='flex items-center justify-center gap-4'>
          ...
          <Input
            type="email"
            placeholder="🔍 Search"
            className={'hidden sm:block w-80 lg:w-150'} />
          <div className='relative '>
            <div
              className='px-2 py-1 border-1 rounded hover:bg-gray-200'
        ...
        <div className='flex items-center gap-4'>
          ...
          <div
            className='rounded-full bg-purple-400 text-white h-8 w-8
          md:h-10 md:w-10 flex justify-center items-center'>VP</div>
        </div>
      </div>
    </div>
  )
